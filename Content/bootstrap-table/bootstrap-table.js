	...
	function () {
	  ...
	  _createClass(BootstrapTable, [{
	    ...
	    value: function initToolbar() {
		  ...
		  //html.push('<button class="btn btn-secondary" type="button"><span class="fa fa-cog"></span></button>');
		...
		let m = {
			session: window.localStorage.getItem("eysln_com")
		};

		top.QueryString.Initial();
		let wechat = top.QueryString.GetValue("wechat");
		if (wechat) {
			m.wechat = wechat;
		}

		let site = top.QueryString.GetValue("site");
		if (site) {
			m.site = site;
		}
