  ...
  function initUploadBtn() {
    ...
    domUtils.on(btnIframe, "load", function() {
      ...
      domUtils.on(input, "change", function() {
        ...
        //form.action = "/api/UpFileH5/UploadFile?pageId=11111111-1111-1111-1111-111111111111";
        //form.submit();

        var f = new FormData();
        let file = input.files[0];
        f.append("file", file); //第一个参数是后台读取的请求key值
        //form.append("fileName", file.name);
        //form.append("other", "666666"); //实际业务的其他请求参数
        var xhr = new XMLHttpRequest();
        var action = "/api/UpFileH5/UploadFile?pageId=11111111-1111-1111-1111-111111111111";
        xhr.open("POST", action);
        xhr.setRequestHeader('session', window.localStorage.getItem("eysln_com"));
        xhr.send(f); //发送表单数据
